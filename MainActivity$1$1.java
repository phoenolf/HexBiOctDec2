    ...
    implements android.view.ner
{
    ...
    public void onClick(View view)
    {
        ...
        {
            int i = Integer.parseInt(editText.getText().toString(), 2);
            ...
            textView4.setText((new StringBuilder()).append(" ").append(i).append(" ").append("DEC  ").toString());
            return;
        }
    }
    ...
    // Unreferenced inner class com/application/phoen/hexbioctdecconverter/MainActivity$1
...
//            editText.setText("");
//            Toast.makeText(MainActivity.this, "Please enter a Binary value.", 0).show();
//            button.setOnClickListener(new MainActivity._cls1._cls1());
//        }
//
//
//            {
